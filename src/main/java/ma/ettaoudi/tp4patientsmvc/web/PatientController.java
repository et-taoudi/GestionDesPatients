package ma.ettaoudi.tp4patientsmvc.web;
...
public class PatientController {
    ...
    //méthode pour retourner une vue patient
    ...
    @GetMapping("/patients")
    @ResponseBody //Dire à Dispacher Servlet que ce résulat va se séréaliser dans le corps de la réponse
